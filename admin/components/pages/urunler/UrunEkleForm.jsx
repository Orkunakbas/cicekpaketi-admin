            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <Textarea
                  ...
                  placeholder="Örn: Saksı Çapı: 21 cm&#10;Bitki Boyu: 60-80 cm&#10;Sulama: Haftada 1-2 kez"
                  ...
                  description="Her satıra bir özellik yazın"
                />
              </div>
            </div>
          )}
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <Select
                    ...
                    placeholder="Kategoriler seçin (birden fazla seçilebilir)"
                    selectionMode="multiple"
                    selectedKeys={formData.category_id ? new Set((Array.isArray(formData.category_id) ? formData.category_id : [formData.category_id]).filter(id => id != null && id !== '' && id !== 0).map(String)) : new Set()}
                    onSelectionChange={(keys) => {
                      const selectedIds = Array.from(keys).map(Number).filter(id => id != null && id !== '' && id !== 0);
                      handleChange('category_id', selectedIds);
                    }}
                    variant="bordered"
                    classNames={{
              ...
              <div className="border-t border-gray-700 pt-6 space-y-6">
                ...
                <div className="bg-card border border-gray-700 rounded-xl p-6">
                  <h4 className="text-base font-semibold text-white mb-4 flex items-center gap-2">
                    ...
                    Varyant Tiplerini Seç
                  </h4>
                  <div className="grid grid-cols-3 gap-3">
                    {optionTypes && optionTypes.length > 0 ? optionTypes.map((type) => (
                      <label
                        key={type.id}
                        className={`relative flex items-center gap-3 px-4 py-3 rounded-lg border-2 cursor-pointer transition-all ${
                          ...
                          <div className="space-y-4 py-2 px-2">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                              ...
                              <Input
                                ...
                                type="number"
                                placeholder="80.00"
                                value={combination.discount_price}
                                onValueChange={(value) => {
                                  const updated = variantCombinations.map(c => 
